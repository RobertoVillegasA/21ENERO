...
lyr_AFILIADOS_2.set('fieldLabels', {'Id': 'no label', 'NroLote': 'header label - visible with data', 'Manzano': 'header label - visible with data', 'Codigo': 'no label', 'CANTIDAD': 'no label', 'UV': 'no label', 'Nro_Manzan': 'inline label - visible with data', 'Nro_Lote': 'inline label - visible with data', 'Nom_Prop': 'inline label - always visible', 'CI-1': 'no label', 'CI-Expedid': 'no label', 'Prop2': 'inline label - visible with data', 'CI-1_1': 'no label', 'CI-Expedi2': 'no label', 'Sup_Plano': 'no label', 'Departamen': 'no label', 'Provincia': 'no label', 'Canton': 'no label', 'Distrito': 'no label', 'SubDistrit': 'no label', 'Sector': 'no label', 'FechaCompr': 'no label', 'Vendedor': 'no label', 'Obs': 'no label', 'Documentos': 'no label', });
lyr_Area21EneroPol_3.set('fieldLabels', {'Id': 'no label', 'area': 'no label', });
lyr_Lotes_4.set('fieldLabels', {'Id': 'no label', 'NroLote': 'no label', 'Manzano': 'no label', 'Codigo': 'no label', });
lyr_Manzano_5.set('fieldLabels', {'Id': 'no label', 'Manzano': 'no label', });
